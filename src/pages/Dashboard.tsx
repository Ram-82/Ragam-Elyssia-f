        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="flex justify-between items-center py-6">
            ...
            <div className="hidden md:flex items-center space-x-12">
              <span className="text-warm-gray text-sm">Welcome, arfath</span>
              <Link href="/login" className="flex items-center space-x-1 text-warm-gray hover:text-charcoal transition-colors font-inter tracking-wide text-sm">
                <span>Sign Out</span>
