  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-ivory">
        ...
        <div className="fixed bottom-4 right-4 z-50 sm:bottom-8 sm:right-8 xs:hidden">
          <a 
            href="https://wa.me/919632069662?text=Hello! I'm interested in Ragam Elyssia's luxury services."
            target="_blank"
            rel="noopener noreferrer"
            aria-label="Chat on WhatsApp"
            className="bg-green-500 hover:bg-green-600 text-white p-3 sm:p-4 rounded-full shadow-luxury hover:shadow-luxury-lg transition-all duration-300 flex items-center justify-center border-4 border-white"
          >
            {/* WhatsApp SVG Icon */}
